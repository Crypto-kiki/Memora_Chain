    ...
    <>    
      ...
      <form onSubmit={handleSubmit} className='mr-8 ml-6'>
        ...
        <div className='grid grid-cols-2 gap-2 justify-items-center'>          
          <CanvasForm metadata = {metaData2} fontstyle={fontstyle}  img={setCanvasImage1} file={file}/>
          <CanvasForm2 metadata = {metaData2} fontstyle={fontstyle}  img={setCanvasImage2} file={file}/>
          <CanvasForm3 metadata = {metaData2} fontstyle={fontstyle}  img={setCanvasImage3} file={file} />
          <CanvasForm4 metadata = {metaData2} fontstyle={fontstyle}  img={setCanvasImage4} file={file}/>
        </div>
    </>
  );
};
