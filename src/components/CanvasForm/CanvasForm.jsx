      ...
      image.onload = () => {
        ...
        if(iw >1100){
          ...
          console.log(`fonts :${fonts}`);
              ...
              ctx.fillText("MEMO", cw / 2 - (rectWidth2 * iar * 0.5) / 2 + rectWidth2 * iar * 0.5 +12, ch / 2 - (rectheight2 * 0.5) / 2 + rectheight2 * 0.5 -120) ;    
              ctx.font = "14px EL";
              ctx.fillStyle = "#4d4d4d"
              ctx.fillText("Lorem Ipsum is simply dummy ",cw / 2 - (rectWidth2 * iar * 0.5) / 2 + rectWidth2 * iar * 0.5 +12, ch / 2 - (rectheight2 * 0.6) / 2 + rectheight2 * 0.6 -80 )
              ctx.fillText("text of the printing and ",cw / 2 - (rectWidth2 * iar * 0.5) / 2 + rectWidth2 * iar * 0.5 +12, ch / 2 - (rectheight2 * 0.6) / 2 + rectheight2 * 0.6 -60)
              ctx.fillText("typesetting industry  ",cw / 2 - (rectWidth2 * iar * 0.5) / 2 + rectWidth2 * iar * 0.5 +12, ch / 2 - (rectheight2 * 0.6) / 2 + rectheight2 * 0.6 -40 )
              ctx.font = "14px EL";
              ctx.fillStyle = "#4d4d4d"
              ...
              ctx.fillText(`Location : ${lat.toFixed(4)}, ${lon.toFixed(4)}`, -(ch-35), 65)
              ctx.rotate((-270 * Math.PI) / 180); 
          ...
          ctx.drawImage(
            ...
            (cw / 1.84) * 0.6
              ...
              ctx.font = "bold 17px EL";
              ctx.fillStyle = "#4d4d4d"
              ctx.fillText("MEMO", cw / 2 - (rectWidth2 * iar * 0.6) / 2 + rectWidth2 * iar * 0.6 +12, ch / 2 - (rectheight2 * 0.6) / 2 + rectheight2 * 0.6 -120) ;    
              ctx.font = "14px EL";
              ctx.fillStyle = "#4d4d4d"
              ctx.fillText("Lorem Ipsum is simply dummy ",cw / 2 - (rectWidth2 * iar * 0.6) / 2 + rectWidth2 * iar * 0.6 +12, ch / 2 - (rectheight2 * 0.6) / 2 + rectheight2 * 0.6 -80 )
              ctx.fillText("text of the printing and ",cw / 2 - (rectWidth2 * iar * 0.6) / 2 + rectWidth2 * iar * 0.6 +12, ch / 2 - (rectheight2 * 0.6) / 2 + rectheight2 * 0.6 -60)
              ctx.fillText("typesetting industry  ",cw / 2 - (rectWidth2 * iar * 0.6) / 2 + rectWidth2 * iar * 0.6 +12, ch / 2 - (rectheight2 * 0.6) / 2 + rectheight2 * 0.6 -40 )
              ctx.font = "14px EL";
              ctx.fillStyle = "#4d4d4d"
              ctx.fillText("made by memorachain",cw-160,ch-30)
              ctx.rotate((270 * Math.PI) / 180);
        ...
        if (iar < 0.9) {
          if (iar < 0.6) {
            ...
            ctx.drawImage(image2,20,20,74,74);
                ...
                ctx.fillText(
                  text2,
                 - (ch / 2 - ch / 18.18  - (rectheight2 * (2 - iar) - rectheight2) + (textWidth*2) ),
                  (cw / 2 - cw / 7.33) -13
                );
                ctx.font = "15px EL";
                ctx.fillStyle = "#808080";
          ...
          ctx.drawImage(image2,20,20,74,74);
                ...
                ctx.font = "14px EL";
                ctx.fillStyle = "#4d4d4d"
                ctx.fillText("Lorem Ipsum is simply dummy ",cw / 2.03, ch / 1.1 - 60 )
