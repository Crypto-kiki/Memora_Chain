...
function CanvasForm3({
  ...
  image3.src = `${process.env.PUBLIC_URL}/image/logo6.png`;
  ...
  useEffect(() => {
    ...
    if (size[0] == 1) {
      image.onload = () => {
        ...
        ctx.fillText("IN CHAIN.", x + width * 0.5 + 40, y + 60);
        ...
        ctx.font = "13px EL";
        ctx.fillStyle = "black";
        ctx.fillText("2023. July 2st", x, y + height * 0.5 + 35);
      ...
      image.onload = () => {
        ...
        if (iar < 0.9) {
          ...
          if (iar < 0.5) {
            ...
            ctx.fillText("IN CHAIN.", x, y + height + 80);
            ...
            ctx.font = "13px EL";
            ctx.fillStyle = "black";
            ctx.fillText("2023. July 2st", x, y2 + 45);
            ctx.font = "lighter 14px EL";
            ctx.fillStyle = "black";
            ...
            ctx.fillText("IN CHAIN.", x, y + height + 80 - 50);
            ...
            ctx.font = "13px EL";
            ctx.fillStyle = "black";
            ctx.fillText("2023 July 2st", x, y2 + 95);
