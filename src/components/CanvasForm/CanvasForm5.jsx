    ...
    const ch = canvas.height;
      ...
      if(size[0]==1){
        ...
        const iar = iw / ih;
          ...
          ctx.fillRect(cw/2-(cw/1.39*0.8)/2,ch/2-(ch/1.15)/2, cw/1.39*0.8,  ch/1.15 );
     ...
     //배경 크기맞추기용 틀
     ctx.fillStyle = "#ffffff";
     ctx.fillRect(cw/2-(cw/1.39*0.8)/2 -100,ch/2-(ch/1.15)/2, cw/1.39*0.8*1.4,  ch/1.15 );
            ...
            ctx.drawImage(
            image,
            cw/2-270,ch/2-(ch/1.15)/2 , 340, 478
          )
          ...
          font.load().then(() => {
            ...
            ctx.fillStyle = "black"
            ctx.font = "25px Montserrat";
            ctx.fillText(`Name22: ${metadata.name}`, cw/2+90, ch/4.2 -30);
